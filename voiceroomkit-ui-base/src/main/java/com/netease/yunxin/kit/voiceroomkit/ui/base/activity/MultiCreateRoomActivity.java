...
public abstract class MultiCreateRoomActivity extends BaseActivity {
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    cover = "https://yx-web-nosdn.netease.im/common/855b98bd26ce3164b88f70835a2e8983/Group%202795.png";
    setEvent();
  }
                 ...
                 // binding.etRoomName.setText(neVoiceCreateRoomDefaultInfo.getTopic());
                  ...
                  if (defaultPictures != null && !defaultPictures.isEmpty()) {
                    if (TextUtils.isEmpty(cover)) {
                      ...
                      cover = firstCover;
                        System.out.println(defaultPictures);
                      System.out.println("HERE, PICTURES ABOVE");
                    }
