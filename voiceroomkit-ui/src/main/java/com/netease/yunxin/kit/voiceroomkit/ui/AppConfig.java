...
public class AppConfig {
  private static final String APP_KEY = "c92ce58a027d659e41ba62da6819fb92"; // 请填写应用对应的AppKey，可在云信控制台的”AppKey管理“页面获取
  public static final String APP_SECRET =
      "22759cffdce7"; // 请填写应用对应的AppSecret，可在云信控制台的”AppKey管理“页面获取
  ...
  public static final String BASE_URL = "https://ffg.ioevisa.com/"; //云信派对服务端国内的体验地址
