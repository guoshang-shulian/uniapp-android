...
public class ExpressEngineProxy {
    ...
    public void createEngine(Application application, long appID, String appSign, ZegoScenario scenario) {
        try {
            ...
            Log.d("ZEGOxxxv", "application = " + application);
            Log.d("ZEGOxxxv", "appID = " + appID);
            Log.d("ZEGOxxxv", "scenario = " + scenario);
            ...
            Log.d("ZEGOxxxv", "before createEngine");

            ZegoExpressEngine.createEngine(profile, null);

            Log.d("ZEGOxxxv", "after createEngine");

            ZegoExpressEngine engine = ZegoExpressEngine.getEngine();

            Log.d("ZEGOxxxv", "engine = " + engine);

            if (engine == null) {
                Log.e("ZEGOxxxv", "ZegoExpressEngine creation failed, engine is null");
                return;
            }

            engine.setEventHandler(expressEventHandler);

            Log.d("ZEGOxxxv", "setEventHandler success");

        } catch (Exception e) {
            Log.e("ZEGOxxxv", "createEngine exception", e);
        }
    }
