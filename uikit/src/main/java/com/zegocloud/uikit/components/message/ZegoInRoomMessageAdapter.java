...
class ZegoInRoomMessageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public String[] decodeJsonToArray(String userName) {
        ...
        try {
            ...
            String fullAvatarUrl = profilePath.isEmpty() ? "" : baseCDN + profilePath;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (itemViewProvider != null) {
            ...
            String[] profileData = decodeJsonToArray(fromUserName);
            fromUserName = profileData[0];
            String name = profileData[0];
            System.out.println("name v is "+name);
